...
class DatabaseError extends Error {
    constructor(level, code, message, detail, hint, file, line, routine, position) {
        super(message);
        this.level = level;
        this.code = code;
...
function writeMessageInto(code, segments, buffer) {
    ...
    for (let i = 0; i < length; i++) {
        ...
        switch (segment) {
            ...
            case SegmentType.Int64BE: {
                const n = value instanceof node_buffer_1.Buffer ? value.readBigInt64BE(0)
    ...
    bind(name, portal, format = types_js_1.DataFormat.Binary, values = [], types = []) {
        ...
        const addBinaryValue = (value, dataType) => {
            ...
            switch (dataType) {
                ...
                case types_js_1.DataType.Int8: {
                    size = add(SegmentType.Int64BE, value instanceof node_buffer_1.Buffer ? value.readBigInt64BE(0)
                        : typeof value === 'bigint' ? value
                            : Number(value));
                    break;
                }
