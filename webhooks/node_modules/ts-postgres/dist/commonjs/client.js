...
exports.ClientImpl = exports.SSLMode = void 0;
...
class ClientImpl {
    ...
    constructor(config = {}) {
        ...
        this.stream.on('error', (error) => {
            if (this.connecting) {
                ...
                if (error.errno === node_os_1.constants.errno.ECONNRESET)
                    return;
                if (this.ending) {
                    this.ending(error);
                }
    ...
    startup() {
        ...
        if (ssl !== SSLMode.Disable) {
            ...
            this.stream.once('data', (buffer) => {
                ...
                const context = ssl.options ? (0, node_tls_1.createSecureContext)(ssl.options) : undefined;
                const options = {
                    socket: this.stream,
    ...
    parseError(buffer) {
        ...
        if (level && code && message) {
            return new protocol_js_1.DatabaseError(level, code, message, ...optional);
        }
